...
I am looking for a small, well-specified contribution that I can understand, test, and complete within the Unit 2 time window. I prefer documentation or configuration fixes with clear affected files, and I am also comfortable with a contained Python change when an existing test identifies the expected behavior. I want to avoid changes that require broad product decisions, design debates, or touching several unrelated subsystems.
